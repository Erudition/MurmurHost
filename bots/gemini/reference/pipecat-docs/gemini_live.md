...
<CardGroup cols={2}>
  <Card title="API Reference" icon="book" href="/api-reference/server/services/s2s/gemini-live">
...
<Frame><img src="https://mintcdn.com/daily/jHf4uyQMOanEqe_B/images/gemini-live-architecture.png?fit=max&auto=format&n=jHf4uyQMOanEqe_B&q=85&s=af85a896b9d5d5d74b507492035ce543" alt="Gemini Live Architecture" width="2110" height="484" data-path="images/gemini-live-architecture.png" /></Frame>
...
<Card title="Pipecat Cloud Deployment" icon="cloud" href="/pipecat-cloud/fundamentals/deploy">
...
<CardGroup cols={2}>
  ...
  <Card title="Telephony Guide" icon="phone-volume" href="/pipecat-cloud/guides/telephony/twilio-websocket">
    Deep dive into phone integrations
  </Card>

  <Card title="Core Concepts" icon="graduation-cap" href="/pipecat/learn/overview">

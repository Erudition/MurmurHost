...
declare module "sox-stream" {
    namespace Sox {
        export type Combine = "concatenate" | "sequence" | "mix" | "mix-power" | "merge" | "multiply";
        ...
        export type Endian = "little" | "big" | "swap";
    ...
    function Sox(options: Sox.SoxOptions): NodeJS.ReadWriteStream;

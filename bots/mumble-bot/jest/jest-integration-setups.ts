...
import { mumbleAgent } from "../src/test-utils/mumble-agent";

setupJestScreenshot();

const key = readFileSync(`${__dirname}/agent.key`, "utf8");
const cert = readFileSync(`${__dirname}/agent.cert`, "utf8");

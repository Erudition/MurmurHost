...
class MumbleRecBot:
    ...
    def __init__(self):
        ...
        self.mumble = pymumble.Mumble(HOST, USER, PORT, PASSWORD, reconnect=True, certfile="cert.pem", keyfile="key.pem")
        ...
        print(self.mumble.channels)
        self.mumble.channels[CHANNEL].move_in()  # move to the configured channel
...
#TODO: check if message is sent only to me
    ...
    def loop(self):
        ...
        silent = "\x00" * int(STEREO_CHUNK_SIZE)
